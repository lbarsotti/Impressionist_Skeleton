...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickSave(View v){
        Bitmap toSave = _impressionistView.savePainting();
        MediaStore.Images.Media.insertImage(getContentResolver(), toSave, "painting.jpg", "custom painting");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            try {
                ...
                _impressionistView.setOtherBitmap(bitmap);
            } catch (IOException e) {
                e.printStackTrace();
            }
